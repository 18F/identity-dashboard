    ...
    context 'help_text config' do
      ...
      context 'when not a Login.gov admin' do
        ...
        it 'rejects help text params if any are custom' do
          ...
          put :update, params: {id: sp.id, service_provider: { issuer: sp.issuer, help_text: custom_params}}
          sp.reload
          ...
          expect(sp.help_text['forgot_password']['en']).to eq(original_help_text['forgot_password']['en'])
        end
        ...
        it 'allows help text params if all are presets' do
          ...
          expect(sp.help_text['sign_in']['en']).to eq(t('service_provider_form.help_text.sign_in.first_time', sp_name: sp.friendly_name))
          expect(sp.help_text['sign_up']['en']).to_not eq(original_help_text['sign_up']['en'])
          expect(sp.help_text['forgot_password']['en']).to_not eq(original_help_text['forgot_password']['en'])
        end
      end
    end
