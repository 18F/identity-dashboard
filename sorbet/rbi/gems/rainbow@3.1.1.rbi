...
# source://rainbow//lib/rainbow/ext/string.rb#6
module Rainbow::Ext; end

# source://rainbow//lib/rainbow/ext/string.rb#7
module Rainbow::Ext::String; end

# source://rainbow//lib/rainbow/ext/string.rb#8
module Rainbow::Ext::String::InstanceMethods
  # source://rainbow//lib/rainbow/ext/string.rb#16
  def background(*color); end

  # source://rainbow//lib/rainbow/ext/string.rb#40
  def blink; end

  # source://rainbow//lib/rainbow/ext/string.rb#24
  def bright; end

  # source://rainbow//lib/rainbow/ext/string.rb#9
  def color(*color); end

  # source://rainbow//lib/rainbow/ext/string.rb#9
  def colour(*color); end

  # source://rainbow//lib/rainbow/ext/string.rb#52
  def cross_out; end

  # source://rainbow//lib/rainbow/ext/string.rb#28
  def faint; end

  # source://rainbow//lib/rainbow/ext/string.rb#9
  def foreground(*color); end

  # source://rainbow//lib/rainbow/ext/string.rb#48
  def hide; end

  # source://rainbow//lib/rainbow/ext/string.rb#44
  def inverse; end

  # source://rainbow//lib/rainbow/ext/string.rb#32
  def italic; end

  # source://rainbow//lib/rainbow/ext/string.rb#20
  def reset; end

  # source://rainbow//lib/rainbow/ext/string.rb#52
  def strike; end

  # source://rainbow//lib/rainbow/ext/string.rb#36
  def underline; end
end
...
# source://rainbow//lib/rainbow/ext/string.rb#62
class String
  include ::Comparable
