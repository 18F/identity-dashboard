...
class SimpleForm::FormBuilder < ::ActionView::Helpers::FormBuilder
  ...
  # source://actionview/7.1.5/lib/action_view/helpers/form_options_helper.rb#860
  def collection_enum(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://simple_form//lib/simple_form/form_builder.rb#397
  def collection_enum_radio_buttons(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end
  ...
  # collection is given.
  #
  # source://enum_help/0.0.19/lib/enum_help/simple_form.rb#7
...
class SimpleForm::Inputs::Base
  ...
  # source://actionview/7.1.5/lib/action_view/helpers/translation_helper.rb#18
