...
module OmniAuth::RailsCsrfProtection::TokenVerifier::HelperMethods
  # source://actionpack/7.1.5/lib/action_controller/metal/request_forgery_protection.rb#101
  def form_authenticity_token(*args, **_arg1, &block); end

  # source://actionpack/7.1.5/lib/action_controller/metal/request_forgery_protection.rb#102
