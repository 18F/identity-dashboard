...
class Rack::Timeout
  ...
  # source://rack-timeout//lib/rack/timeout/core.rb#90
  def call(env); end
  ...
  class << self
    # source://rack-timeout//lib/rack/timeout/core.rb#183
    ...
    # @return [Boolean]
    #
    # source://rack-timeout//lib/rack/timeout/core.rb#194
    def _request_has_body?(env); end

    # source://rack-timeout//lib/rack/timeout/core.rb#201
    def _set_state!(env, state); end

    # Sends out the notifications. Called internally at the end of `_set_state!`
    #
    # source://rack-timeout//lib/rack/timeout/core.rb#226
    ...
    # @raise [RuntimeError]
    #
    # source://rack-timeout//lib/rack/timeout/core.rb#213
    def register_state_change_observer(id, &callback); end

    # Removes the observer with the given id
    #
    # source://rack-timeout//lib/rack/timeout/core.rb#220
...
# source://rack-timeout//lib/rack/timeout/core.rb#182
...
# shorthand reference
#
# source://rack-timeout//lib/rack/timeout/core.rb#89
Rack::Timeout::RT = Rack::Timeout

# source://rack-timeout//lib/rack/timeout/core.rb#181
Rack::Timeout::RX_APACHE_X_REQUEST_START = T.let(T.unsafe(nil), Regexp)

# source://rack-timeout//lib/rack/timeout/core.rb#180
...
# This is a code extraction for readability, this method is only called from a single point.
#
# source://rack-timeout//lib/rack/timeout/core.rb#179
...
#
# source://rack-timeout//lib/rack/timeout/support/scheduler.rb#17
class Rack::Timeout::Scheduler
  include ::Rack::Timeout::MonotonicTime

  # @return [Scheduler] a new instance of Scheduler
  #
  # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#57
  def initialize; end
  ...
  #
  # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#77
  def run_loop!; end

  # returns the runner thread, creating it if needed
  #
  # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#68
  def runner; end

  class << self
    # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#151
    def delay(*a, &b); end
    ...
    #
    # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#145
    def singleton; end
  end
end
...
# source://rack-timeout//lib/rack/timeout/support/scheduler.rb#42
class Rack::Timeout::Scheduler::RepeatEvent < ::Rack::Timeout::Scheduler::RunEvent
  ...
  # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#50
  def run!; end
end

# stores a proc to run later, and the time it should run at
#
# source://rack-timeout//lib/rack/timeout/support/scheduler.rb#22
class Rack::Timeout::Scheduler::RunEvent < ::Struct
  ...
  # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#28
  def cancel!; end

  # @return [Boolean]
  #
  # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#32
  def cancelled?; end

  # source://rack-timeout//lib/rack/timeout/support/scheduler.rb#36
  def run!; end
end
