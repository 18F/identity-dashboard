...
module SamlIdp::IdpController::HelperMethods
  ...
  def saml_acs_url(*args, **_arg1, &block); end
end
...
# source://saml_idp//lib/saml_idp/logout_request_builder.rb#3
class SamlIdp::LogoutRequestBuilder < ::SamlIdp::LogoutBuilder
  # @return [LogoutRequestBuilder] a new instance of LogoutRequestBuilder
  #
  # source://saml_idp//lib/saml_idp/logout_request_builder.rb#7
  def initialize(response_id, issuer_uri, saml_slo_url, name_id, algorithm, x509_certificate = T.unsafe(nil), secret_key = T.unsafe(nil)); end

  # Returns the value of attribute algorithm.
  #
  # source://saml_idp//lib/saml_idp/logout_request_builder.rb#4
  def algorithm; end
  ...
  # Sets the attribute name_id
  #
  # @param value the value to set the attribute name_id to.
  #
  # source://saml_idp//lib/saml_idp/logout_request_builder.rb#4
  def name_id=(_arg0); end
  ...
  # source://saml_idp//lib/saml_idp/logout_request_builder.rb#25
  def build; end
end
...
class SamlIdp::Request
  ...
  # source://saml_idp//lib/saml_idp/request.rb#96
  def acs_url; end
  ...
  # source://saml_idp//lib/saml_idp/request.rb#164
  def cert_errors; end
  ...
  # source://saml_idp//lib/saml_idp/request.rb#182
  ...
  # source://saml_idp//lib/saml_idp/request.rb#113
  def log(msg); end
  ...
  # source://saml_idp//lib/saml_idp/request.rb#153
  def matching_cert; end

  # source://saml_idp//lib/saml_idp/request.rb#214
  def name_id; end

  # source://saml_idp//lib/saml_idp/request.rb#218
  def name_id_format; end
  ...
  def requested_authn_context; end

  # source://saml_idp//lib/saml_idp/request.rb#78
  def requested_authn_context_comparison; end

  # source://saml_idp//lib/saml_idp/request.rb#82
  def requested_authn_contexts; end

  # source://saml_idp//lib/saml_idp/request.rb#90
  def requested_vtr_authn_contexts; end

  # source://saml_idp//lib/saml_idp/request.rb#105
  def response_url; end

  # source://saml_idp//lib/saml_idp/request.rb#203
  def service_provider; end

  # @return [Boolean]
  #
  # source://saml_idp//lib/saml_idp/request.rb#199
  def service_provider?; end
  ...
  # @return [Boolean]
  #
  # source://saml_idp//lib/saml_idp/request.rb#186
  def signed?; end

  # @return [Boolean]
  #
  # source://saml_idp//lib/saml_idp/request.rb#121
  def valid?; end

  # @return [Boolean]
  #
  # source://saml_idp//lib/saml_idp/request.rb#190
  def valid_signature?; end

  private

  # source://saml_idp//lib/saml_idp/request.rb#278
  def assertion; end

  # source://saml_idp//lib/saml_idp/request.rb#249
  def authn_context_node; end

  # source://saml_idp//lib/saml_idp/request.rb#256
  def authn_context_nodes; end

  # source://saml_idp//lib/saml_idp/request.rb#263
  def authn_request; end

  # source://saml_idp//lib/saml_idp/request.rb#37
  def config(*_arg0, **_arg1, &_arg2); end

  # source://saml_idp//lib/saml_idp/request.rb#228
  def document; end

  # source://saml_idp//lib/saml_idp/request.rb#268
  def logout_request; end

  # source://saml_idp//lib/saml_idp/request.rb#233
  def name_id_format_node; end

  # source://saml_idp//lib/saml_idp/request.rb#242
  def requested_authn_context_node; end

  # source://saml_idp//lib/saml_idp/request.rb#273
  def samlp; end

  # source://saml_idp//lib/saml_idp/request.rb#288
  def service_provider_finder; end

  # source://saml_idp//lib/saml_idp/request.rb#283
  def signature_namespace; end
...
class SamlIdp::XMLSecurity::SignedDocument
  ...
  # source://saml_idp//lib/saml_idp/xml_security.rb#80
  def validate_doc(base64_cert, soft = T.unsafe(nil), options = T.unsafe(nil)); end

  private

  # source://saml_idp//lib/saml_idp/xml_security.rb#266
  def algorithm(element); end

  # matches RubySaml::Utils
  #
  # source://saml_idp//lib/saml_idp/xml_security.rb#143
  def build_query(params); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#252
  def canon_algorithm(element); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#231
  def digest_method_algorithm(ref); end

  # @return [Boolean]
  #
  # source://saml_idp//lib/saml_idp/xml_security.rb#248
  def digests_match?(hash, digest_value); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#287
  def extract_inclusive_namespaces; end

  # source://saml_idp//lib/saml_idp/xml_security.rb#113
  def find_base64_cert(options); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#104
  def fingerprint_cert(cert, options); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#109
  def fingerprint_cert_sha1(cert); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#293
  def log(msg, level: T.unsafe(nil)); end
  ...
  # source://saml_idp//lib/saml_idp/xml_security.rb#93
  def signature_algorithm(options); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#172
  def validate_doc_embedded_signature(base64_cert, soft = T.unsafe(nil)); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#151
  def validate_doc_params_signature(base64_cert, soft = T.unsafe(nil), params); end

  # source://saml_idp//lib/saml_idp/xml_security.rb#235
