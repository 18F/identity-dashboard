...
ActiveRecord::Schema[8.1].define(version: 2025_12_12_194057) do
  ...
  create_table "service_providers", id: :serial, force: :cascade do |t|
    ...
    t.index ["uuid"], name: "index_service_providers_on_uuid", unique: true
  end
  ...
  create_table "team_memberships", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: nil, null: false
    t.integer "user_id"
    t.index ["group_id"], name: "index_team_memberships_on_group_id"
