...
gem 'enum_help'
gem 'faraday', '>= 2.14.3'
gem 'identity-hostdata', git: 'https://github.com/18F/identity-hostdata.git', tag: 'v4.4.2'
gem 'identity-logging', git: 'https://github.com/18f/identity-logging.git', tag: 'v0.1.0'
gem 'identity_validations', git: 'https://github.com/18f/identity-validations.git', tag: 'v0.9.1'
